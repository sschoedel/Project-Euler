grid = [ 8, 2,22,97,38,15, 0,40, 0,75, 4, 5, 7,78,52,12,50,77,91, 8,#0
...
for r in range(20):
	for c in range(17):
		horizontal.append(prod([value_at(r,c+i) for i in range(4)]))
for c in range(20):
	for r in range(17):
		vertical.append(prod([value_at(r+i,c) for i in range(4)]))
for r in range(4,20):
	for c in range(17):
		diagonalpos.append(prod([value_at(r-i,c+i) for i in range(4)]))
for r in range(17):
	for c in range(17):
		diagonalneg.append(prod([value_at(r+i,c+i) for i in range(4)]))
print(max(max(horizontal),max(vertical),max(diagonalpos),max(diagonalneg)))

print([value_at(0,0+i) for i in range(4)])